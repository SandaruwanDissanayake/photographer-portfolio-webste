                                ...
                                <div class="col-lg-8 m-auto">
                                    <div class="slider-item-content">
                                        ...
                                        <h1 class="entry-title">
                                            <a href="post-default.html">5 Effective Ways I’m Finding Focus in a Busy
                                                Season of Life</a>
                                        </h1>
                            ...
                            <div class="row">
                                <div class="col-lg-8 m-auto">
                                    <div class="slider-item-content">
                                        ...
                                        <h1 class="entry-title">
                                            <a href="post-default.html">7 Holiday Decor Ideas and Exactly What I Love
                                                About Each One</a>
                                        </h1>
                                        <ul class="entry-meta list-inline">
                                            <li class="post-author-img">
                            ...
                            <div class="row">
                                <div class="col-lg-8 m-auto">
                                    <div class="slider-item-content">
                                        ...
                                        <h1 class="entry-title">
                                            <a href="post-default.html">What Are Your Tips for Hosting an Easy Birthday
                                                Party?
                                            </a>
                                        </h1>
                                        <ul class="entry-meta list-inline">
                            ...
                            <div class="row">
                                <div class="col-lg-8 m-auto">
                                    <div class="slider-item-content">
                                        ...
                                        <h1 class="entry-title">
                                            <a href="post-default.html">Get Mhe Most Out of Iceland Mith our 10 Travel
                                                Mips
                                            </a>
                                        </h1>
                                        <ul class="entry-meta list-inline">
